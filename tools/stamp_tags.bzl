...
"Copied from https://github.com/bazel-contrib/rules_oci/blob/main/examples/push/stamp_tags.bzl"
...
def stamp_tags(name, remote_tags, **kwargs):
    ...
    For example, if you use the expression `($stamp[0].BUILD_EMBED_LABEL // "0.0.0")`, this resolves to
